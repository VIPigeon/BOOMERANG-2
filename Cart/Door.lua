...
local UPPER_LEFT_TILE = data.Door.tiles.upper_left_tile
local UPPER_RIGHT_TILE = data.Door.tiles.upper_right_tile
local BOTTOM_RIGHT_TILE = data.Door.tiles.bottom_right_tile
